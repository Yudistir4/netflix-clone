    ...
    return (
        <div className="flex flex-col items-center justify-center gap-4 px-10 py-10 lg:flex-row">
            <div className="relative z-20 lg:w-1/2 flex flex-col justify-center items-center gap-5 text-center lg:text-left lg:pl-10">
                <h2 className="text-3xl sm:text-5xl font-bold w-full">{home.section4.title}</h2>
                <p className="text-xl lg:text-2xl">{home.section4.p}</p>
            </div>
            <div className="relative lg:w-1/2   lg:m-0">

                <img src="/assets/all-device.png" alt="" className=' relative   w-full z-10  -m' />
                ...
                <div className="w-[62%]   absolute z-0 top-[31%] left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <div className="relative pt-[56.25%] w-full  ">

                        {show &&
                            <ReactPlayer
                                url="/assets/video-all-device.m4v"
